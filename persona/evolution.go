...
func Reflect(
	...
	store.SaveMetric(resp.Model, resp.PromptTokens, resp.CompletionTokens, resp.TotalTokens, resp.CostUSD, 0, 0, resp.UsedFallback, "dream")
...
func classifyAndRetryPersona(
	...
	store.SaveMetric(retryResp.Model, retryResp.PromptTokens, retryResp.CompletionTokens, retryResp.TotalTokens, retryResp.CostUSD, 0, 0, retryResp.UsedFallback, "dream")
...
func twoStepRewrite(
	...
	store.SaveMetric(analysisResp.Model, analysisResp.PromptTokens, analysisResp.CompletionTokens, analysisResp.TotalTokens, analysisResp.CostUSD, 0, 0, analysisResp.UsedFallback, "dream")
	...
	store.SaveMetric(composeResp.Model, composeResp.PromptTokens, composeResp.CompletionTokens, composeResp.TotalTokens, composeResp.CostUSD, 0, 0, composeResp.UsedFallback, "dream")
