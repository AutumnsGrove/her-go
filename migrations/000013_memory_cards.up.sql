-- ============================================================
-- 000013: Memory Cards — schema, seeds, assignments, rewrites
-- ============================================================
...
-- Organic card (not protected)
INSERT OR IGNORE INTO memory_cards (topic_slug, name, subject, protected) VALUES
    ('patterns',  'Patterns',  'user', 0);

-- --------------------------------------------------------
-- Part 3: Card assignments
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Part 4: Combined memory rewrites
-- --------------------------------------------------------
