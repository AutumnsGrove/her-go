...
var affectWords = []string{
	...
	"deadnamed", "defeated", "depressed", "destroyed",
	"devastated", "disappointed", "discouraged", "disgusted",
	"doomed", "down", "drained", "dread", "dysphoric",
	"embarrassed", "empty", "erased", "exhausted", "flat",
	"frustrated", "furious", "gray", "grey", "grieving",
	"grumpy", "guilty", "heartbroken", "heavy", "helpless",
	"hopeless", "hostile", "hurt", "insecure", "invalidated",
	"irritated", "jealous", "livid", "lonely", "lost",
	"miserable", "misgendered", "moody", "neglected", "numb",
	...
	"tired", "trapped", "uneasy", "unhappy", "unseen",
	"upset", "wiped", "worried", "worthless", "wretched",

	// Pleasant — high valence
	"accepted", "adored", "affirmed", "alive", "amazing",
	"awesome", "blessed", "blissful", "brave", "bright",
	"brilliant", "buzzing", "cheerful", "cherished", "cozy",
	"delighted", "ecstatic", "elated", "energized", "euphoric",
	"excellent", "excited", "exhilarated", "fantastic", "free",
	"fulfilled", "giddy", "glad", "glorious", "glowing",
	"gorgeous", "grateful", "great", "happy", "heavenly",
	"hopeful", "hyped", "incredible", "inspired", "joyful",
	"jubilant", "loved", "magnificent", "motivated",
	"outstanding", "overjoyed", "peaceful", "perfect",
	"proud", "pumped", "radiant", "refreshed", "relieved",
	"seen", "stoked", "superb", "thankful", "thrilled",
	"unreal", "upbeat", "valid", "validated", "vibrant",
	"wonderful",
