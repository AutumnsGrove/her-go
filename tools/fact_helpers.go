...
//
// Sub-memories skip the classifier — they were generated by it, so they're
// implicitly approved. Each gets its own embedding (using the content text
// directly, since we don't have per-sub-memory tags) and an autolink pass.
